(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Components_TabComponents_AddUser_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    addUser: function addUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('https://warm-ocean-82842.herokuapp.com/api/companies', {
        NIP: this.NIP,
        REGON: this.REGON,
        NAZWA: this.REGON,
        VAT: this.VAT,
