(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Components_TabComponents_EditUser_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    editUser: function editUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().patch("https://warm-ocean-82842.herokuapp.com/api/companies/".concat(this.$route.params.id), {
        NIP: this.NIP,
        REGON: this.REGON,
        NAZWA: this.REGON,
        VAT: this.VAT,
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("https://warm-ocean-82842.herokuapp.com/api/companies/".concat(this.$route.params.id)).then(function (res) {
